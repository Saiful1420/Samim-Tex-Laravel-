...
<style>
    body {
  background: url(public/font-end/images/bg.jpg);
...
<h3 class="text-center text-success">{{ Session::get('successmessage')}} </h3>
    ...
    <form class="form-login" method="POST" action="{{url('/admin-login')}}">
      {{ csrf_field() }}
        <h2 class="form-login-heading">Welcome to Samin Tex login</h2>
        ...
        <div class="copywrite text-center" style="font-size: 12px;margin-top: 15px;>
          <div class="text-center"> <b style="font-size: 14px;"> Copyright &copy; <a href="https://www.creativepos.com.bd">Samin Tex</a>&nbsp; <?php echo date("Y") ?>.</b><br>
  <div class="footer text-center" style="font-size: 15px;margin-left: -6px;">
     <b> Develop by</b> <a style="color:red;" href="https://www.creativesoftware.com.bd">Symex it ltd</a>
  </div>
